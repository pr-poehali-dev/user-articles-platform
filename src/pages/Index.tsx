...
const articles = [
  {
    ...
    description: "Полезные советы по оптимизации React-приложений, которые помогут значительно увеличить производительность.",
    author: {
      name: "Алексей Иванов",
      image: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?q=80&w=250"
    },
    category: "React",
  ...
  },
  {
    ...
    description: "Разбираемся, почему TypeScript стал так популярен, и какие преимущества он даёт разработчикам.",
    author: {
      name: "Мария Соколова",
  ...
  },
  {
    ...
    description: "Какая архитектура подойдет именно вашему проекту? Разбираем преимущества и недостатки каждого подхода.",
    author: {
      name: "Дмитрий Петров",
      image: "https://images.unsplash.com/photo-1607990281513-2c110a25bd8c?q=80&w=250"
    },
  ...
  },
  {
    ...
    description: "Практическое руководство по использованию современных нейросетей для ускорения процесса разработки.",
    author: {
      name: "Анна Волкова",
      ...
      <header className="sticky top-0 z-30 w-full bg-white dark:bg-gray-800 border-b shadow-sm">
        <div className="container flex h-16 items-center px-4 sm:px-6">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm font-medium">
            <a href="#" className="transition-colors hover:text-purple-600">Главная</a>
            <a href="#" className="transition-colors hover:text-purple-600">Статьи</a>
            <a href="#" className="transition-colors hover:text-purple-600">Авторы</a>
            <a href="#" className="transition-colors hover:text-purple-600">О нас</a>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-purple-600">Главная</a></li>
                <li><a href="#" className="text-gray-600 hover:text-purple-600">Статьи</a></li>
                <li><a href="#" className="text-gray-600 hover:text-purple-600">Авторы</a></li>
                <li><a href="#" className="text-gray-600 hover:text-purple-600">О нас</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold mb-4">Информация</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-purple-600">Помощь</a></li>
                <li><a href="#" className="text-gray-600 hover:text-purple-600">Правила</a></li>
                <li><a href="#" className="text-gray-600 hover:text-purple-600">Конфиденциальность</a></li>
                <li><a href="#" className="text-gray-600 hover:text-purple-600">Контакты</a></li>
              </ul>
            </div>
            <div>
